...
class ResepLocal extends StatelessWidget {
  const ResepLocal({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      ...
      itemCount: ListItemResepLocal.length,
      itemBuilder: (context, index, pageViewIndex) {
        final ItemResep resep = ListItemResepLocal[index];
        return InkWell(
          onTap: () {
